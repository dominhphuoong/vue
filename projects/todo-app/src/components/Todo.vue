<template>
        <div class='ui centered card'>
            ...
            <div class="content" v-show="isEditing">
                <div class="ui form">
                    ...
                    <div class="field">
                        ...
                        <input type="text" name="project" id="project" v-model="todo.project">
                    </div>
            ...
            <div class="ui bottom attached red basic button" v-on:click="completeTodo(todo)" v-show="!todo.done">Complete</div>
        </div>
</template>
<script>
export default {
